...
async function getStaticProps() {
    const about = await (0,_lib_mdx__WEBPACK_IMPORTED_MODULE_2__/* .getFileBySlug */ .x7)("pages", [
        "about"
    ]);
    const teamRaw = fs__WEBPACK_IMPORTED_MODULE_3___default().readFileSync(`./data/team.json`);
...
var __webpack_exports__ = __webpack_require__.X(0, [895,664,675,152,635,831,397,961,924,1], () => (__webpack_exec__(8953)));
